...
import com.huhusky.common.utils.util.JsonUtil;
import com.huhusky.common.utils.util.StringUtil;
...
/*    public static HttpEntity<String> getRestRawRequestEntity(String raw) {

        HttpHeaders headers = new HttpHeaders();
        MediaType type = MediaType.parseMediaType("application/json; charset=UTF-8");
        headers.setContentType(type);
        headers.add("Accept", MediaType.APPLICATION_JSON.toString());
        HttpEntity<String> formEntity = new HttpEntity<>(raw, headers);
        return formEntity;
    }*/
